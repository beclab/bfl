...
require (
	...
	kubesphere.io/kubesphere v0.0.0-20210927071953-bab5cf27e33a
...
replace (
	...
	kubesphere.io/client-go => ../../kubesphere-ext/staging/src/kubesphere.io/client-go
	kubesphere.io/kubesphere => ../../kubesphere-ext
)
